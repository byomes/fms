      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 text-center py-24">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/resources"
              className="px-8 py-3 bg-blue-700 text-white font-sans font-medium text-sm uppercase tracking-wide hover:bg-blue-800 transition-colors duration-200"
            >
              Browse Resources
            </Link>
            <Link
      ...
      <section className="bg-gray-50 py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              <h2 className="font-display text-5xl lg:text-6xl uppercase tracking-wider text-blue-900 mb-4">
                GODFIDENCE
              </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="lg:order-1">
              ...
              <a
                ...
                className="inline-block px-8 py-3 border border-blue-700 text-blue-700 font-sans font-medium text-sm uppercase tracking-wide hover:bg-blue-700 hover:text-white transition-colors duration-200"
              >
                Explore Adelphos ↗
              </a>
            </div>
